...
namespace ke
{
	...
	/// <summary>
	/// KEngie Button is rectangle based on 2x SFML RectangleShape that can carry texture and color at the same time
	/// </summary>
	...
	public:
		...
		/// <summary>
		/// Default Button counstructor
		/// </summary>
		/// <remarks> 
		/// Note that object is not initialized here
		/// </remarks>
		/// <sealso cref="Button::create"/>
		Button();
		...
		/// <param name="character_size"></param>
		/// <param name="text_position">text position relative to the object</param>
		/// <param name="object_color">colored object color</param>
		/// <param name="text_color"></param>
		/// <param name="outline_thickness">colored shape outline thickness</param>
		/// <param name="outline_color">colored shape outline color</param>
		/// <param name="rotation">object rotation in degrees</param>
		...
		/// <summary>
		/// Button copy cosntructor
		/// </summary>
		/// <param name="other">copied Button</param>
		/// <remarks>
		...
		/// <summary>
		/// returns poiter to textured shape
		/// </summary>
		...
		/// <summary>
		/// returns poiter to colored shape
		/// </summary>
		/// <returns>SFML RectangleShape</returns>
		...
		/// <summary>
		/// reverses order of rendering; | 0: texture -> color | ,  | 1: color -> texture |
		/// </summary>
		...
		/// reverses order of rendering; | 0: texture -> color | ,  | 1: color -> texture |
		/// </summary>
		/// <param name="order">rener order</param>
	...
	private:
		...
		sf::RectangleShape	m_texture_shape;	// textured shape
		sf::RectangleShape	m_color_shape;		// colored shape
		...
		bool m_render_order;	// which object is rendered first? Texture or Color?
