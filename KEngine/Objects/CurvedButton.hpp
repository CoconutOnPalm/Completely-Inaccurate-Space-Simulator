...
namespace ke
{
	...
	/// <summary>
	/// KEngine CurvedButton is a button armed wirh two circles on left and right side that makes in look like curved button
	/// </summary>
	...
	public:
		...
		/// <summary>
		/// Default CurvedButton constructor
		/// </summary>
		CurvedButton();
		...
		/// <param name="position">objet position relatod to origin</param>
		/// <param name="origin">pbkect origin</param>
		/// <param name="texture">middle button texture</param>
		/// <param name="text">object texty</param>
		/// <param name="character_size">text size</param>
		/// <param name="text_position">text position</param>
		...
		/// <param name="position">objet position relatod to origin</param>
		/// <param name="origin">pbkect origin</param>
		/// <param name="texture_path">path to middle button texture</param>
		/// <param name="text">object texty</param>
		/// <param name="character_size">text size</param>
		/// <param name="text_position">text position</param>
		/// <param name="object_color">object color</param>
		...
		/// <summary>
		/// CurvedButton copy constructor
		/// </summary>
		/// <param name="other">othrt CurvedButton</param>
		...
		/// CurvedButton copy constructor
		/// </summary>
		/// <param name="other">other CurvedButton</param>
		...
		/// returns left circle
		/// </summary>
		/// <returns>SFML Circle</returns>
		sf::CircleShape* getLeftCircle();


		/// <summary>
		/// returns right circle
		/// </summary>
		/// <returns>SFML circle</returns>
		...
		/// <summary>
		/// sets middle button texture
		/// </summary>
		/// <param name="texture">pointer to oryginal texture</param>
		/// <remarks>
	...
	private:
		...
		/// <summary>
		/// Updates object (circle position)
		/// </summary>
		void shapeUpdate();
		...
		Button			m_shape;	// middle rectangle
		sf::CircleShape m_cCicle_L;	// left	  circle
		sf::CircleShape m_cCicle_R;	// right  circle

		int m_origin; // object origin
	};
