...
void Credits::InitState()
{
	...
	m_credits.emplace_back(std::make_unique<ke::Button>(sf::Vector2f(winSize.x, winSize.y / 18), position, ke::Origin::MIDDLE_MIDDLE, nullptr, L"Project manager",							winSize.x / 40, ke::Origin::MIDDLE_MIDDLE, sf::Color::Transparent, sf::Color(255, 255, 255, 255))); position.y += m_credits.back()->getSize().y + small_space;
	...
	m_credits.emplace_back(std::make_unique<ke::Button>(sf::Vector2f(winSize.x, winSize.y / 18), position, ke::Origin::MIDDLE_MIDDLE, nullptr, L"guys from GIMP",										winSize.x / 50, ke::Origin::MIDDLE_MIDDLE, sf::Color::Transparent, sf::Color(192, 192, 192, 192))); position.y += m_credits.back()->getSize().y + small_space;
	m_credits.emplace_back(std::make_unique<ke::Button>(sf::Vector2f(winSize.x, winSize.y / 18), position, ke::Origin::MIDDLE_MIDDLE, nullptr, L"guys from Google drawings",							winSize.x / 50, ke::Origin::MIDDLE_MIDDLE, sf::Color::Transparent, sf::Color(192, 192, 192, 192))); position.y += m_credits.back()->getSize().y + small_space;
	m_credits.emplace_back(std::make_unique<ke::Button>(sf::Vector2f(winSize.x, winSize.y / 18), position, ke::Origin::MIDDLE_MIDDLE, nullptr, L"guys from Raw Therapee",								winSize.x / 50, ke::Origin::MIDDLE_MIDDLE, sf::Color::Transparent, sf::Color(192, 192, 192, 192))); position.y += m_credits.back()->getSize().y + small_space;
	m_credits.emplace_back(std::make_unique<ke::Button>(sf::Vector2f(winSize.x, winSize.y / 18), position, ke::Origin::MIDDLE_MIDDLE, nullptr, L"guys from Notepad++",								winSize.x / 50, ke::Origin::MIDDLE_MIDDLE, sf::Color::Transparent, sf::Color(192, 192, 192, 192))); position.y += m_credits.back()->getSize().y + small_space;
	m_credits.emplace_back(std::make_unique<ke::Button>(sf::Vector2f(winSize.x, winSize.y / 18), position, ke::Origin::MIDDLE_MIDDLE, nullptr, L"guys from Audacity",									winSize.x / 50, ke::Origin::MIDDLE_MIDDLE, sf::Color::Transparent, sf::Color(192, 192, 192, 192))); position.y += m_credits.back()->getSize().y + 4 * empty_space;
