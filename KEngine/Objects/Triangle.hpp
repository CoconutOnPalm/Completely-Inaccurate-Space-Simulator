...
namespace ke
{
	...
	/// <summary>
	/// KEngie Triangle is a equilateral triangle based on SFML CircleShape that can carry a texture or text
	/// </summary>
	class Triangle : public GuiObject
	{
	public:
		...
		/// <summary>
		/// Triangle constructor for color and text 
		/// </summary>
		/// <param name="side_length">the length of the side of the triangle</param>
		/// <param name="position">triangle position relative to origin</param>
		/// <param name="origin">shape origin</param>
		/// <param name="text">text displayed with triangle</param>
		/// <param name="character_size">text size</param>
		/// <param name="text_position">text position relative to the triangle</param>
		/// <param name="object_color">shape color</param>
		/// <param name="text_color">text color</param>
		/// <param name="outline_thickness">shape outline shickness</param>
		/// <param name="outline_color">shape outline color</param>
		...
		/// <summary>
		/// Triangle constructor for texture
		/// </summary>
		/// <param name="side_length">the length of the side of the triangle</param>
		/// <param name="position">triangle position relative to origin</param>
		/// <param name="origin">shape origin</param>
		...
		/// <param name="rotation">rotation in degrees</param>
		/// <param name="acitve">if object is processed and rendered</param>
		...
		/// <param name="object_color">shape color</param>
		/// <param name="text_color">text color</param>
		/// <param name="outline_thickness">shape outline thickness</param>
		/// <param name="outline_color">shape outlne color</param>
		/// <param name="rotation">rotation in degrees</param>
		/// <param name="text_style">SFML text style</param>
		/// <param name="text_shift">Vector2f correcting tex position</param>
		/// <param name="font">KEngie Font inherited form GuiObject</param>
		...
		/// <summary>
		/// Creates textured triangle
		/// </summary>
		/// <param name="side_length">the length of the side of the triangle</param>
		/// <param name="position">triangle position relative to origin</param>
		/// <param name="origin">shpae origin</param>
		/// <param name="texture">SFML texture</param>
		/// <param name="rotation">rotation in degrees</param>
		/// <param name="acitve">if object is processed and rendered</param>
		void create(
		...
		/// <summary>
		/// sets object size by the length of the side of the triangle
		/// </summary>
		/// <param name="a">the length of the side of the triangle</param>
		void setSideSize(float a);


		/// <summary>
		/// retutns the length of the side of the triangle
		/// </summary>
		/// <returns>the length of the side of the triangle</returns>
		...
		/// <summary>
		/// is typical Invaded() but works like for rectangle
		/// </summary>
		/// <param name="mousePositon">point (mouse position)</param>
		/// <returns>if collides, true</returns>
		...
		/// <summary>
		/// inits physics (note that triangle will not behave correctly - same borders as circle)
		/// </summary>
		/// <remarks>
