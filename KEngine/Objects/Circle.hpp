...
namespace ke
{
	...
	/// <summary>
	/// KEngine Circle is a circle based on SFML CircleShape that can carry a texture or text
	/// </summary>
	...
	public:
		...
		/// <summary>
		/// Circle constructor for color and text
		/// </summary>
		/// <param name="radius">circle radius</param>
		/// <param name="position">circle position relative to origin</param>
		/// <param name="origin">shape origin</param>
		/// <param name="text">text displayed with circle</param>
		/// <param name="character_size">text size</param>
		/// <param name="text_position">text position relative to the circle</param>
		...
		/// <summary>
		/// Circle constructor for texture
		/// </summary>
		/// <param name="radius">circle radius</param>
		/// <param name="position">circle position</param>
		/// <param name="origin">shape origin</param>
		...
		/// <summary>
		/// Creates colored circle with text
		/// </summary>
		/// <param name="radius">circle radius</param>
		/// <param name="position">circ;e position relative to origin</param>
		/// <param name="origin">shhape origin</param>
		/// <param name="text">text displayed with circle</param>
		/// <param name="character_size"text size></param>
		/// <param name="text_position">text position relative to the circle</param>
		/// <param name="object_color">shape color</param>
		/// <param name="text_color">text color</param>
		/// <param name="outline_thickness">circle ooutline thickness</param>
		/// <param name="outline_color">circle outline color</param>
		/// <param name="rotation">rotation in degrees</param>
		/// <param name="text_style">SFML tex tstyle</param>
		/// <param name="text_shift">Vector2f correcting tex position</param>
		/// <param name="font">KEngie Font inherited form GuiObject</param>
		/// <param name="active">if object is processed and rendered</param>
		void create(
		...
		/// <summary>
		/// checks if point (mouse position) is on rectangle described on the object
		/// </summary>
		/// <param name="mousePosition"></param>
		/// <returns>if collides, true</returns>
		bool isInvaded_rect(const sf::Vector2f& mousePosition) const;
