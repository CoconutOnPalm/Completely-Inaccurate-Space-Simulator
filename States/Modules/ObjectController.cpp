...
void ObjectController::addObject(ObjectBuffer* object_data, const sf::Vector2f& position, const sf::Vector2f& viewSize, const sf::Vector2f& winSize, const std::string& name, const sf::Vector2<double>& velocity)
{
	...
	// TODO: dodać strulture ze skalami;
...
void ObjectController::createObjectPreview(ObjectBuffer* object_data, objvector::iterator selected_object, iconvector::iterator selected_icon)
{
	...
	case STAR:
		...
		m_placed_object->create(object_data->radius() * m_space_scale * m_star_scale, pos_buffer, ke::Origin::MIDDLE_MIDDLE, L"", 0, ke::Origin::MIDDLE_MIDDLE, sf::Color::Transparent);
